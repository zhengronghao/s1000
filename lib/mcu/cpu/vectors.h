...
#define VECTOR_039      default_isr     // 0x0000_009C 39    23		RNG              Random Number Generator
...
#define VECTOR_044      default_isr     // 0x0000_00B0 44    28     I2S0             I2S0 Transmit
#define VECTOR_045      default_isr     // 0x0000_00B4 45    29     I2S0             I2S0 Receive
#define VECTOR_046      default_isr     // 0x0000_00B8 46    30     UART0            Single interrupt vector for UART LON sources
...
#define VECTOR_070      default_isr     // 0x0000_0118 70    54     USB Chg Detect   
#define VECTOR_071      default_isr     // 0x0000_011C 71    55     DryIce           Tamper
...
#define VECTOR_075      default_isr     // 0x0000_012C 75    59     Port ctrl module Pin detect (Port A)
#define VECTOR_076      default_isr     // 0x0000_0130 76    60     Port ctrl module Pin detect (Port B)
#define VECTOR_077      default_isr     // 0x0000_0134 77    61     Port ctrl module Pin detect (Port C)
#define VECTOR_078      default_isr     // 0x0000_0138 78    62     Port ctrl module Pin detect (Port D)
#define VECTOR_079      default_isr     // 0x0000_013C 79    63     Port ctrl module Pin detect (Port E)
#define VECTOR_080      default_isr     // 0x0000_0140 80    64     Software 	     Software interrupt
#define VECTOR_081      default_isr     // 0x0000_0140 80    65     SPI2             Single interrupt vector for all sources         
#define VECTOR_082      default_isr     // 0x0000_0140 80    66     UART4            Single interrupt vector for UART status sources 
...
#define VECTOR_087      default_isr     // 0x0000_015C 87    71     FTM0             Single interrupt vector for all sources         
