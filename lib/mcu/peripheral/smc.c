...
//#define DBG_LPWR_TRACE

#ifdef DBG_LPWR_TRACE
#define LPWR_TRACE(...)  printk(__VA_ARGS__)
#else
#define LPWR_TRACE(...)
#endif
/********************************************************************/
...
void enter_vlpr(char lpwui_value)
{
    ...
    LPWR_TRACE("[enter_vlpr] Now in VLPR at 19200 baud  \r\n");
...
void enter_vlls0(void)
{
    ...
    /* Now execute the stop instruction to go into VLLS1 */
    LPWR_TRACE("[enter_vlls0]SMC_PMPROT   = %#02X \r\n", (SMC_PMPROT))  ;
    LPWR_TRACE("[enter_vlls0]SMC_PMCTRL   = %#02X \r\n", (SMC_PMCTRL))  ;
    LPWR_TRACE("[enter_vlls0]SMC_VLLSCTRL   = %#02X \r\n", (SMC_VLLSCTRL))  ;
    LPWR_TRACE("[enter_vlls0]SMC_PMSTAT   = %#02X \r\n", (SMC_PMSTAT))  ;
    LPWR_TRACE("\n                                        ");
    stop();
}
/********************************************************************/
...
void enter_vlls0_nopor(void)
{
    ...
    /* Now execute the stop instruction to go into VLLS1 */
    LPWR_TRACE("[enter_vlls0_nopor]SMC_PMPROT   = %#02X \r\n", (SMC_PMPROT))  ;
    LPWR_TRACE("[enter_vlls0_nopor]SMC_PMCTRL   = %#02X \r\n", (SMC_PMCTRL))  ;
    LPWR_TRACE("[enter_vlls0_nopor]SMC_VLLSCTRL   = %#02X \r\n", (SMC_VLLSCTRL))  ;
    LPWR_TRACE("[enter_vlls0_nopor]SMC_PMSTAT   = %#02X \r\n", (SMC_PMSTAT))  ;
    LPWR_TRACE("\n                                        ");
    stop();
}
/********************************************************************/
...
void enable_lpwui(void)
{
    ...
    LPWR_TRACE("[enable_lpwui]SMC_PMCTRL   = %#02X \r\n", (SMC_PMCTRL))  ;
}
/********************************************************************/
...
{
    SMC_PMCTRL &= ~SMC_PMCTRL_LPWUI_MASK;
    LPWR_TRACE("[disable_lpwui]SMC_PMCTRL   = %#02X \r\n", (SMC_PMCTRL))  ;
}
