 ...
 * =====================================================================================
 *
 *       Filename:  MifshalHw_Rc663_Reg.h
 *
 *    Description:  
 *
 *        Version:  1.0
 *        Created:  11/12/2012 9:57:40 AM
 *       Revision:  none
 *       Compiler:  gcc
 *
...
/** 
*
* default protocol reg
*
*/
#define PHHAL_HW_RC663_REG_PINEN                0x44
#define PHHAL_HW_RC663_REG_PINOUT               0x45
#define PHHAL_HW_RC663_REG_PININ                0x46
//sigout select
...
#define PHHAL_HW_RC663_REG_TXSYMFREG            0x4C
#define PHHAL_HW_RC663_REG_TXSYM0H              0x4D
#define PHHAL_HW_RC663_REG_TXSYM0L              0x4E
#define PHHAL_HW_RC663_REG_TXSYM                0x4F
...
#define PHHAL_HW_RC663_REG_FABCALI              0x5F
/** \name Command Register Contents (0x00)
*/
/*@{*/
#define PHHAL_HW_RC663_BIT_STANDBY              (uchar)0x80   /**< Standby bit; If set, the IC transits to standby mode. */
#define PHHAL_HW_RC663_CMD_IDLE                 (uchar)0x00   /**< No action; cancels current command execution. */
#define PHHAL_HW_RC663_CMD_LPCD                 (uchar)0x01   /**< Low Power Card Detection. */
#define PHHAL_HW_RC663_CMD_LOADKEY              (uchar)0x02   /**< Reads a key from the FIFO buffer and puts it into the key buffer. */
#define PHHAL_HW_RC663_CMD_MFAUTHENT            (uchar)0x03   /**< Performs the Mifare standard authentication (in Mifare Reader/Writer mode only). */
#define PHHAL_HW_RC663_CMD_ACKREQ               (uchar)0x04   /**< Performs a Query, a Ack and a Req-Rn for EPC V2. */
#define PHHAL_HW_RC663_CMD_RECEIVE              (uchar)0x05   /**< Activates the receiver circuitry. */
#define PHHAL_HW_RC663_CMD_TRANSMIT             (uchar)0x06   /**< Transmits data from the FIFO buffer to Card. */
#define PHHAL_HW_RC663_CMD_TRANSCEIVE           (uchar)0x07   /**< Like #PHHAL_HW_RC663_CMD_TRANSMIT but automatically activates the receiver after transmission is finished. */
#define PHHAL_HW_RC663_CMD_WRITEE2              (uchar)0x08   /**< Gets one byte from FIFO buffer and writes it to the internal EEPROM. */
#define PHHAL_HW_RC663_CMD_WRITEE2PAGE          (uchar)0x09   /**< Gets up to 64 Bytes from FIFO buffer and writes it to the EEPROM. */
#define PHHAL_HW_RC663_CMD_READE2               (uchar)0x0A   /**< Reads data from EEPROM and puts it into the FIFO buffer. */
#define PHHAL_HW_RC663_CMD_LOADREG              (uchar)0x0C   /**< Reads data from EEPROM and initializes the registers. */
#define PHHAL_HW_RC663_CMD_LOADPROTOCOL         (uchar)0x0D   /**< Reads data from EEPROM and initializes the registers needed for a protocol change. */
#define PHHAL_HW_RC663_CMD_LOADKEYE2            (uchar)0x0E   /**< Copies a Mifare key from the EEPROM into the key buffer. */
#define PHHAL_HW_RC663_CMD_STOREKEYE2           (uchar)0x0F   /**< Stores a Mifare key into the EEPROM. */
#define PHHAL_HW_RC663_CMD_SOFTRESET            (uchar)0x1F   /**< Resets the IC. */
#define PHHAL_HW_RC663_MASK_COMMAND             (uchar)0x1F   /**< Mask for Command-bits. */
/*@}*/
...
//ÖÐ¶Ï¼Ä´æÆ÷¸÷Î»ÅäÖÃ
#define  RC663_IRQ_RXSOF (1<<0)  
#define  RC663_IRQ_ERR 	 (1<<1)  
#define  RC663_IRQ_RX    (1<<2)  
#define  RC663_IRQ_TX    (1<<3)  
#define  RC663_IRQ_IDLE  (1<<4)  
#define  RC663_IRQ_LO    (1<<5)  
#define  RC663_IRQ_HI    (1<<6)  

//#define  RC663_IRQ_TIMER  (gtRfidProInfo.Timerflg<<8)  
#define  RC663_IRQ_TIMER0 (1<<8)  
#define  RC663_IRQ_TIMER1 (1<<9)  
#define  RC663_IRQ_TIMER2 (1<<10)  
#define  RC663_IRQ_TIMER3 (1<<11)  
#define  RC663_IRQ_TIMER4 (1<<12)  
#define  RC663_IRQ_LPCD   (1<<13)  
#define  RC663_IRQ_GLOBAL (1<<14)  

#define  RC663_IRQ_ALL   (RC663_IRQ_RX|RC663_IRQ_TX|RC663_IRQ_IDLE|RC663_IRQ_LO|RC663_IRQ_HI|RC663_IRQ_TIMER1)
#define  RC663_IRQ_NONE  0

// ´íÎó×´Ì¬¼Ä´æÆ÷ÅäÖÃ
//#define  RC663_COLLERR     (1<<3)
//#define  RC663_PARITYERR   (1<<1)
//#define  RC663_FRAMINGERR  (1<<0)
//#define  RC663_CRCERR      (1<<2)
//#define  RC663_OVFLERR     (1<<4)
//#define  RC663_ALLERR      (RC663_COLLERR | RC663_PARITYERR | RC663_FRAMINGERR | RC663_CRCERR | RC663_OVFLERR)
//                           PHHAL_HW_RC663_BIT_EE_ERR     
//                           PHHAL_HW_RC663_BIT_FIFOWRERR  
#define  RC663_OVFLERR     PHHAL_HW_RC663_BIT_FIFOOVL    
//                           PHHAL_HW_RC663_BIT_MINFRAMEERR
//                           PHHAL_HW_RC663_BIT_NODATAERR  
#define  RC663_COLLERR     PHHAL_HW_RC663_BIT_COLLDET    
#define  RC663_FRAMINGERR  PHHAL_HW_RC663_BIT_PROTERR    
#define  RC663_CRCERR      PHHAL_HW_RC663_BIT_INTEGERR   

#define  RC663_ALLERR      (RC663_COLLERR | RC663_FRAMINGERR | RC663_CRCERR | RC663_OVFLERR)
#ifdef __cplusplus
} /* Extern C */
#endif
