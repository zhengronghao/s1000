...
/* DRY */
#define DRY_SKVR                                 DRY_SKVR_REG(DRY)
#define DRY_SKWLR                                DRY_SKWLR_REG(DRY)
#define DRY_SKRLR                                DRY_SKRLR_REG(DRY)
#define DRY_CR                                   DRY_CR_REG(DRY)
#define DRY_SR                                   DRY_SR_REG(DRY)
#define DRY_LR                                   DRY_LR_REG(DRY)
#define DRY_IER                                  DRY_IER_REG(DRY)
#define DRY_TSR                                  DRY_TSR_REG(DRY)
#define DRY_TER                                  DRY_TER_REG(DRY)
#define DRY_PDR                                  DRY_PDR_REG(DRY)
#define DRY_PPR                                  DRY_PPR_REG(DRY)
#define DRY_ATR0                                 DRY_ATR_REG(DRY,0)
#define DRY_ATR1                                 DRY_ATR_REG(DRY,1)
#define DRY_PGFR0                                DRY_PGFR_REG(DRY,0)
#define DRY_PGFR1                                DRY_PGFR_REG(DRY,1)
#define DRY_PGFR2                                DRY_PGFR_REG(DRY,2)
#define DRY_PGFR3                                DRY_PGFR_REG(DRY,3)
#define DRY_PGFR4                                DRY_PGFR_REG(DRY,4)
#define DRY_PGFR5                                DRY_PGFR_REG(DRY,5)
#define DRY_PGFR6                                DRY_PGFR_REG(DRY,6)
#define DRY_PGFR7                                DRY_PGFR_REG(DRY,7)
#define DRY_WAC                                  DRY_WAC_REG(DRY)
#define DRY_RAC                                  DRY_RAC_REG(DRY)
#define DRY_SKR0                                 DRY_SKR_REG(DRY,0)
#define DRY_SKR1                                 DRY_SKR_REG(DRY,1)
#define DRY_SKR2                                 DRY_SKR_REG(DRY,2)
#define DRY_SKR3                                 DRY_SKR_REG(DRY,3)
#define DRY_SKR4                                 DRY_SKR_REG(DRY,4)
#define DRY_SKR5                                 DRY_SKR_REG(DRY,5)
#define DRY_SKR6                                 DRY_SKR_REG(DRY,6)
#define DRY_SKR7                                 DRY_SKR_REG(DRY,7)
#define DRY_SWAC                                 DRY_SWAC_REG(DRY)
#define DRY_SRAC                                 DRY_SRAC_REG(DRY)

/* DRY - Register array accessors */
#define DRY_ATR(index)                           DRY_ATR_REG(DRY,index)
#define DRY_PGFR(index)                          DRY_PGFR_REG(DRY,index)
#define DRY_SKR(index)                           DRY_SKR_REG(DRY,index)
...
#define SIM                                      ((SIM_MemMapPtr)SIM_BASE_PTR)
